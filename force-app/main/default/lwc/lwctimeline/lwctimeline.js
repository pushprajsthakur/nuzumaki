...
import timeline from '@salesforce/resourceUrl/timelineV'
import {loadScript,loadStyle} from 'lightning/platformResourceLoader'
export default class Lwctimeline extends LightningElement {
    ...
    this.chart = new vis.Timeline(container, items, options);
